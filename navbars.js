...
document.getElementById('Newsfeed').onclick = function URL() {
 ...
 document.getElementById('Home').onclick = function URL() {
    ...
    document.getElementById('myButton2').onclick =function URL
    (){location.href ='https://twitter.com/paulmccartney?lang=en'}

    document.getElementById('myButton3').onclick = function URL(){location.href='https://www.paulmccartney.com/'}

    document.getElementById('myButton4').onclick = function URL (){location.href='https://www.instagram.com/paulmccartney/?hl=en'}